- # General
  ...
  - #### Project 5 Video Demo Link:
        [link](https://www.youtube.com/watch?v=ICleh9uOSEE)
...
| --------------------------------------------- | ------------------------------------------------ | -------------------------- | ----------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Case 1: HTTP/1 thread                         | ![Link](/IMG/HTTP_1_Thread_2.png)                | 185                        | 4.1677                              | 2.8943                    | Here is our test of HTTP with 1 thread. Compared to Case 1 in the following table, there is a significant difference in not using a load balancer vs using a load balancer, as the TS and TJ values are practically doubled in size.                                                                                                                                                                                                                                                                                                                                                        |
...
| Case 3: HTTPS/10 threads                      | ![Link](/IMG/HTTPS_10_Threads_2.png)             | 371                        | 4.0728                              | 2.8954                    | Here is our test of HTTPS with 10 threads. Unexpectedly, our average query time was slightly longer than that of Case 2 with the HTTP with 10 threads. What was even more surprising was that the TS and TJ were doubled in length of time, as we assumed that it would be shorter because of the overhead provided by HTTPS. However, in comparing to Case 4 of this table, we can at least see that the use of connection pooling with 10 threads has a much shorter running time in general than without the use of connection pooling.                                                  |
| Case 4: HTTP/10 threads/No connection pooling | ![Link](/IMG/HTTP_No_Conn_Pool_10_Threads_2.png) | 370                        | 6.0703                              | 4.5799                    | Here is our test without connection pooling. As compared to Cases 1 and 2, the average query time is significant longer, demonstrating the effect of not using connection pooling. The TS and TJ of this test much higher than those from Cases 1-3, which also implies that the lack of connection pooling contributes to this. What was not totally expected was that the average query time for this Case 4 was almost the same for Case 3, but since the difference is not significant in size, we assume this is just because the throughput rates were about the same for both cases. |

| **Scaled Version Test Plan**                  | **Graph Results Screenshot**                            | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| --------------------------------------------- | ------------------------------------------------------- | -------------------------- | ----------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Case 1: HTTP/1 thread                         | ![Link](/IMG/Scaled_HTTP_1_Thread_2.png)                | 197                        | 2.5981                              | 1.9366                    | This is a test of our load balancer with 1 thread. As compared to our Case 1 test without the load balancer in the previous table, tthe TS and TJ values are halved, which demonstrates how well a load balancer divides up the work, even in the case of a single user. However, what was unexpected was that the average query time was a little higher; this is most likely because the throughput for the Case 1 of the previous table was slightly faster than for this table's Case 1.                                                                                                                                                                                                                                                                                                                                                                             |
...
| Case 3: HTTP/10 threads/No connection pooling | ![Link](/IMG/Scaled_No_Conn_Pool_HTTP_10_Threads_2.png) | 310                        | 4.0756                              | 2.932                     | This is a test of our load balancer with 10 threads and no connection pooling. Compared to Case 2 before this, the TS and TJ are somewhat higher, as expected without the benefit of connection pooling. Also, as expected, our TS and TJ were shorter than that of Case 3 from the prior table, which demonstrates the benefit of having a load balancer reducing the running time on average. In addition, the average query time, TS, and TJ of this test were shorter than those of Case 4 in the previous table, which demonstrates the effects of reducing run time using a load balancer vs not using a load balancer.                                                                                                                                                                                                                                            |
